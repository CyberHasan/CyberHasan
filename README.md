...
I design **precision systems** for businesses that outgrew spreadsheets but can't afford enterprise consultants.

```
Accounting Systems     →  Manager.io ERP · Multi-entity · VAT/NBR automation
Healthcare Technology  →  FHIR R4 · Offline-first LIS · Government integration
...
**[🇧🇩 MANAGERIO-VAT-BD](https://github.com/INSPIRONTECH/MANAGERIO-VAT-BD)**
Open-source Bangladesh VAT (Mushak 6.3) automation for Manager.io. NBR-compliant.

`JavaScript` `Open Source` · [Live Demo →](https://inspirontech.github.io/MANAGERIO-VAT-BD/)

</td>
<td width="50%">

**[🛠️ COMMUNITY-TOOLS](https://github.com/INSPIRONTECH/COMMUNITY-TOOLS)**
Open-source utilities and extensions for the Manager.io community.
